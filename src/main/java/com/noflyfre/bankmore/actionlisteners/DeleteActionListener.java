...
public class DeleteActionListener implements ActionListener {
     ...
     * @param tableBudget tabella da modificare
     * @param myBudget bilancio da modificare
     * @param budgetTableModel modello di tabella da modificare
     * @param dataset dataser da modificare per il grafico
     * @param bilancioValue valore bilancio da modificare
     */
    ...
    /**
     * Metodo che elimina una transazione dal bilancio.
     * Questo meotodo elimina la transazione selezionata sulla tabella dal bilancio, ed oltre a ciò,
     * aggiorna la tabella, i dataset per il grafico, ed il valore del bilancio nella GUI.
     */
    public void actionPerformed(ActionEvent e) {
        /**viene usato getRowCount - getSelectedRow - 2, perchè nella visualizzazione della tabella le righe
         * sono invertite rispetto alla realtà, quindi per considerare la riga corretta, devo re-invertire 
         * il valore selezionato. Oltre a ciò, considerando che c'è la riga del totale, va tolto 2 invece
         * che 1.
         */
